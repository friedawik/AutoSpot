...
"""
This code loops through all test images and predicts masks using a finetuned 
SAM2 model with the default prompt grid generated by SAM2.Note that amg must be set to amg=True. 
